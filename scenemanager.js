class SceneManager {
  ...
  loadLevelOne() {
    ...
    let platform1 = new Platform(this.game, 0, 667);
    this.game.entities.push(platform1);
    let platform2 = new Platform(this.game, 400, 667);
    this.game.entities.push(platform2);
    let platform3 = new Platform(this.game, 800, 667);
    this.game.entities.push(platform3);
    let platform4 = new Platform(this.game, 1300, 667);
    this.game.entities.push(platform4);
    let platform5 = new Platform(this.game, 1800, 667);
    this.game.entities.push(platform5);
    let platform6 = new Platform(this.game, 2300, 667);
    this.game.entities.push(platform6);
    let platform7 = new Platform(this.game, 2700, 667);
    this.game.entities.push(platform7);
    let platform8 = new Platform(this.game, 3100, 667);
    this.game.entities.push(platform8);
    let platform9 = new Platform(this.game, 3600, 667);
    this.game.entities.push(platform9);
    let platform10 = new Platform(this.game, 4100, 667);
