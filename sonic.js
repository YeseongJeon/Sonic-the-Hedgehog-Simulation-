...
collisionCheck() {
  this.game.entities.forEach(entity => {
    if (entity.BB && this.BB.collide(entity.BB)) { //falling
      ...
      //Crab and Bug
      if ((entity instanceof EnemiesCrab || entity instanceof Bug || entity instanceof Bat || entity instanceof Bee) //Crab or Bug BB
            && !entity.dead
      ...
      }else if ((entity instanceof EnemiesCrab || entity instanceof Bug || entity instanceof Bat || entity instanceof Bee) //Crab or Bug BB
