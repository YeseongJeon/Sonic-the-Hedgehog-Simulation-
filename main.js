...
ASSET_MANAGER.queueDownload("./sprites/enemiesSonic.png");
ASSET_MANAGER.queueDownload("./sprites/enemySonicCrab.png");
ASSET_MANAGER.queueDownload("./sprites/baddies.png");
...
ASSET_MANAGER.downloadAll(() => {
	...
	gameEngine.addEntity(new Enemies(gameEngine,650,570));
